// Package identities provides managed identity token sources for LLM providers.
// It isolates cloud-specific credential SDKs from the provider layer,
// allowing providers to acquire tokens without importing cloud SDKs directly.
package identities
